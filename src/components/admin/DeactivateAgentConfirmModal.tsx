...
type DeactivateAgentConfirmModalProps = {
  open: boolean;
  onClose: () => void;
  /** Fires when the user confirms deactivation (Yes). */
  onConfirm: () => void;
};

export default function DeactivateAgentConfirmModal({
  open,
  onClose,
  onConfirm,
}: DeactivateAgentConfirmModalProps) {
  useEffect(() => {
    if (!open) return;
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-[400px] rounded-[20px] bg-white px-8 pb-9 pt-10 shadow-[0_20px_50px_rgba(15,23,42,0.18)]"
